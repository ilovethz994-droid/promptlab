const messages = {
  "promptOptimizer": {
    "title": "PromptLab 提示词精修器",
    "inputPlaceholder": "哪怕只写一句话也可以，例如：帮我做一个高级的公司官网",
    "optimize": "一键精修",
    "analyze": "先诊断",
    "analyzing": "分析中...",
    "history": "历史记录",
    ...
    "enterPrompt": "输入提示词",
    "placeholder": "直接写你的真实需求，不用整理。越烂越能看出效果。",
  ...
  "prompt": {
    ...
    "optimizedPlaceholder": "精修后的专业提示词会显示在这里，可直接复制给 ChatGPT / Claude / DeepSeek / Gemini / Cursor 使用。",
    "iterateDirection": "还想往哪个方向继续打磨？",
